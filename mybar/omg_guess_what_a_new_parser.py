...
class Token:
    ...
    def error_leader(self, with_col: bool = False) -> str:
        ...
        # file = self.lexer._file if self.lexer._file is not None else ''
    ...
    def parse_expr(self, prev: Token = None) -> AST:
        ...
        match curr.kind:
            ...
            case Syntax.R_CURLY_BRACE:
                curr.check_expected_after(prev, (Syntax.L_CURLY_BRACE,))
                node = curr
            ...
            case Syntax.R_BRACKET:
                curr.check_expected_after(prev, (Syntax.L_BRACKET,))
                node = curr
